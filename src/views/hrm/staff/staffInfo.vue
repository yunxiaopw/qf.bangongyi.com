  ...
  <div class="main-box">
    ...
    <HeadLine goback>
        ...
        <template #r-content>
            <div class="t-r-btn">
                <el-popconfirm 
                :title="`确定要${we_status === '2' ? '启用': '禁用'}吗？`"
                @confirm="staffDisable"
                >
                    <el-button slot="reference" size="small" >{{ we_status === '2' ? '启用': '禁用' }}</el-button>
                </el-popconfirm>
            </div>
      </template>
    </HeadLine>
    ...
    <div class="staff-infos">
        ...
        <div class="top-card">
            ...
            <div class="info">
                ...
                <div class="center" v-if="staff_texts.master_we_department || staff_texts.rank_id">
                    <div>{{ staff_texts.master_we_department }}</div>
                  ...
                  <el-tabs v-model="activeName" @tab-click="handleClick" :before-leave="beforeLeave">
                    <el-tab-pane label="人事信息" name="staffing">
                        ...
                        <div v-show="staffingEdit">
                            <el-form ref="staffingFormData" :rules="staffingFormDataRules" :model="staffingFormData" size="small" label-width="150px">
                                <div class="staffing">
                                ...
                                <el-row type="flex" class="row-bg" justify="center">
                                    <div class="btns p_b_12">
                                        ...
                                        <el-button size="small" type="primary" @click="submit('staffingFormData')">保存</el-button>
                                    </div>
                                </el-row>
                            </el-form>
                        </div>
                    ...
                    <el-tab-pane label="个人资料" name="person">
                        ...
                        <div v-show="personEdit">
                            <el-form ref="personFormData" :rules="personFormDataRules" :model="personFormData" size="small" label-width="150px">
                                <div class="staffing">
                                ...
                                <el-row type="flex" class="row-bg" justify="center">
                                    <div class="btns p_b_12">
                                        ...
                                        <el-button size="small" type="primary" @click="submit('personFormData')">保存</el-button>
                                    </div>
                                </el-row>
                            </el-form>
                        </div>
                                        ...
                                        <el-form ref="staffingFormData" :rules="staffingFormDataRules" :model="staffingFormData" size="small" label-width="150px">
                                            ...
                                            <el-row type="flex" class="row-bg" justify="center">
                                                <div class="btns">
                                                    ...
                                                    <el-button size="small" type="primary" @click="fileFormData_submit('educations', key)">保存</el-button>
                                                </div>
                                            </el-row>
                                        </el-form>
                                    </div>
                                        ...
                                        <el-form ref="staffingFormData" :rules="staffingFormDataRules" :model="staffingFormData" size="small" label-width="150px">
                                            <div class="staffing no_padding" v-if="fileFormData.copy_works && fileFormData.copy_works.length>0">
                                                ...
                                                <el-form-item label="离职原因：" prop="quite_reason">
                                                    <el-input v-model="fileFormData.copy_works[key].quite_reason" autocomplete="off" placeholder="请输入离职原因"></el-input>
                                                </el-form-item>
                                                <el-form-item label="备注：" prop="remarks">
                                                    <el-input v-model="fileFormData.copy_works[key].remarks" autocomplete="off" placeholder="请输入备注"></el-input>
                                                </el-form-item>
                                            </div>
                                            <el-row type="flex" class="row-bg" justify="center">
                                                <div class="btns">
                                                    <el-button size="small" @click="item.edit = false">取消</el-button>
                                                    <el-button size="small" type="primary" @click="fileFormData_submit('works', key)">保存</el-button>
                                                </div>
                                            </el-row>
                                        </el-form>
                                    </div>
                                    ...
                                    <div class="editCard cardItem" v-if="item.edit">
                                        <el-form ref="staffingFormData" :rules="staffingFormDataRules" :model="staffingFormData" size="small" label-width="150px">
                                            <div class="staffing no_padding" v-if="fileFormData.copy_training && fileFormData.copy_training.length>0">
                                                <el-form-item label="培训公司名称：" prop="institutions">
                                                ...
                                                <el-form-item label="成绩：" prop="achievement">
                                                    <el-input v-model="fileFormData.copy_training[key].achievement" autocomplete="off" placeholder="请输入成绩"></el-input>
                                                </el-form-item>
                                                ...
                                                <el-form-item label="证书编号：" prop="name13">
                                                    <el-input v-model="fileFormData.copy_training[key].certificate_no" autocomplete="off" placeholder="请输入证书编号"></el-input>
                                                </el-form-item>
                                                <el-form-item label="备注：" prop="name2">
                                                    <el-input v-model="fileFormData.copy_training[key].remarks" autocomplete="off" placeholder="请输入备注"></el-input>
                                                </el-form-item>
                                            </div>
                                            <el-row type="flex" class="row-bg" justify="center">
                                                <div class="btns">
                                                    <el-button size="small" @click="item.edit = false">取消</el-button>
                                                    <el-button size="small" type="primary" @click="fileFormData_submit('training', key)">保存</el-button>
                                                </div>
                                            </el-row>
                                        </el-form>
                                    </div>
                                        ...
                                        <el-form ref="staffingFormData" :rules="staffingFormDataRules" :model="staffingFormData" size="small" label-width="150px">
                                            <div class="staffing no_padding" v-if="societyFormData.copy_emergency && societyFormData.copy_emergency.length>0">
                                                ...
                                                <el-form-item label="联系地址：" prop="address">
                                                    <el-input v-model="societyFormData.copy_emergency[key].address" autocomplete="off" placeholder="请输入联系地址"></el-input>
                                                </el-form-item>
                                            </div>
                                            <el-row type="flex" class="row-bg" justify="center">
                                                <div class="btns">
                                                    <el-button size="small" @click="item.edit = false">取消</el-button>
                                                    <el-button size="small" type="primary" @click="societyFormData_submit('emergency', key)">保存</el-button>
                                                </div>
                                            </el-row>
                                        </el-form>
                                    </div>
                                        ...
                                        <el-form ref="staffingFormData" :rules="staffingFormDataRules" :model="staffingFormData" size="small" label-width="150px">
                                            <div class="staffing no_padding" v-if="societyFormData.copy_family && societyFormData.copy_family.length>0">
                                                ...
                                                <el-form-item label="工作单位：" prop="work">
                                                    <el-input v-model="societyFormData.copy_family[key].work" autocomplete="off" placeholder="请输入工作单位"></el-input>
                                                </el-form-item>
                                                <el-form-item label="备注：" prop="remarks">
                                                    <el-input v-model="societyFormData.copy_family[key].remarks" autocomplete="off" placeholder="请输入备注"></el-input>
                                                </el-form-item>
                                            </div>
                                            <el-row type="flex" class="row-bg" justify="center">
                                                <div class="btns">
                                                    <el-button size="small" @click="item.edit = false">取消</el-button>
                                                    <el-button size="small" type="primary" @click="societyFormData_submit('family', key)">保存</el-button>
                                                </div>
                                            </el-row>
                                        </el-form>
                                    </div>
        ...
        <el-row :gutter="20">
            ...
            <el-col :span="10" :offset="4">
                <el-form-item label="账号：" prop="we_userid">
                    <el-input v-model="copy_staffInfoData.we_userid" :disabled="(staff_values.we_userid && staff_values.we_userid.length>0)" autocomplete="off" placeholder="请输入账号"></el-input>
                </el-form-item>
            </el-col>
        </el-row>
        <el-row :gutter="20">
...
<script>
import { dictFormData } from "@/api/hrm/staff";
import { staffInfo, staffEnable, widgetOptions, staffEdit } from "@/api/hrm/staff/staffInfo";
  ...
  methods: {
    ...
    async getDictFormData() {
      await dictFormData().then(res => {
        // 人事信息字典字段
        this.staffingFormDict = setMoreInputI_item(res.data.filter(i => i.type === '1')[0].dict);
        // 个人资料字典字段
        this.personFormDict = setMoreInputI_item(res.data.filter(i => i.type === '2')[0].dict);

        // 人事信息 校验项
        // this.staffingFormDataRules = setFormDataRules(this.staffingFormDict);
        // 个人资料 校验项
        // this.personFormDataRules = setFormDataRules(this.personFormDict);
      })
    },
    // 员工详情 所有可选项数据
    ...
    // 获取员工详情
    getStaffInfo() {
        staffInfo({id: this.id}).then(res => {
            let {we_status, staff, archives_info, dynamic } = res.data;

            this.we_status = we_status;
            this.activities = dynamic;
            // this.staffInfoData = left_1;
            // this.staffingFormData = tab_1;
            // this.personFormData = tab_2;
            this.staffs = staff;
    ...
    // 禁用
    staffDisable() {
        staffEnable({id: this.id}).then(res => {
            this.$message({
              showClose: true,
    ...
    // 档案信息tab内相关内容 编辑后 保存
    fileFormData_submit(key, item_key) {
    ...
    // 社会关系tab内相关内容 编辑后 保存
    societyFormData_submit(key, item_key) {
    ...
    //  所有表单 保存
    submit(editType) {
        let data = this.submitNewData(editType);
        staffEdit(data).then(res => {
            if(res.errno === 0) {
                this.$message({
                    showClose: true,
                    message: res.errmsg,
    ...
    // 所有表单 保存时 处理数据
    submitNewData(editType) {
        let data = { id: this.id };
        if(editType === 'staffInfoData') {
            data = {...data, ...JSON.parse(JSON.stringify(this.copy_staffInfoData))}
        }else if(editType === 'staffingFormData' || editType === 'personFormData') {
            data = {...data, ...JSON.parse(JSON.stringify(this.staff_values))}
        }else if(editType === 'fileFormData' || editType === 'societyFormData') {
            let obj = {};
            obj.archives_info = {...JSON.parse(JSON.stringify(this.fileFormData)), ...JSON.parse(JSON.stringify(this.societyFormData))};
            for (let key in obj.archives_info) {
                if (key.indexOf('copy') !== -1) delete obj.archives_info[key]
            }
            data = {...data, ...obj}
        }
        return data
