  ...
  <div class="content_box">
    <el-form ref="remindFormData" :model="remindFormData" label-width="150px" size="small">
        ...
        <el-form-item label="">
            ...
            <el-button icon="el-icon-plus" size="small" @click="setTopContent('{入职时长(年)}')">入职时长(年)</el-button>
            <el-button icon="el-icon-plus" size="small" @click="setTopContent('{入职时间}')">入职时间</el-button>
        ...
        <el-form-item label="">
            ...
            <el-button icon="el-icon-plus" size="small" @click="setBottomContent('{入职时长(年)}')">入职时长(年)</el-button>
            <el-button icon="el-icon-plus" size="small" @click="setBottomContent('{入职时间}')">入职时间</el-button>
            <span class="hint">点击按钮，在适当的位置添加变量</span>
        </el-form-item>
